...
import SocialLoginError from './components/shared/SocialLoginError';
        ...
        {loading ?
          ...
          <Routes>
            <Route path="/" element={<Layout darkTheme={darkTheme} handleThemeChange={handleThemeChange} />} >
              ...
              <Route path="/sociallogin/error/:provider" element={<SocialLoginError />} />
              ...
              <Route path="/profile/account/verify-email" element={<VerifyEmailPage />} />
            ...
            <Route path="/problems" element={isAuthenticated ? <ProblemsPage darkTheme={darkTheme} handleThemeChange={handleThemeChange} /> : <Navigate to="/login" />}>
              <Route path=":problemId" element={<SolvedProblemPage darkTheme={darkTheme} handleThemeChange={handleThemeChange} />} />
            </Route>
          </Routes>
        }
      </div>
