...
const SolvedProblemPage = ({ darkTheme, handleThemeChange }) => {
        ...
        <div className="flex items-center gap-3 space-x-1">
          ...
          <div className="relative mr-3">
            ...
            >
              ...
              />
              <ChevronDown
                className={`h-4 w-4 ml-1 text-slate-500 dark:text-slate-400 transform transition-transform duration-200 ${isProfileDropdownOpen ? "rotate-180" : ""
                  }`}
              />
            </button>
            <AnimatePresence>
