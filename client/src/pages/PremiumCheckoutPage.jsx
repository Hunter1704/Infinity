...
const PremiumCheckoutPage = () => {
  ...
  const displayRazorpay = useCallback(async () => {
    ...
    const options = {
      key: import.meta.env.VITE_RAZORPAY_KEY_ID, // Use REACT_APP_ prefix for env vars in CRA/Vite
  ...
  return (
    <div className="max-w-4xl mx-auto pt-10 pb-40 px-4 sm:px-6 lg:px-8">
      ...
      <button
        ...
        className="flex items-center space-x-2 text-sm font-medium text-slate-600 dark:text-slate-400 hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors mb-10"
      ...
      {plan ? (
        <div className="bg-white/70 dark:bg-slate-800/60 backdrop-blur-xl rounded-2xl p-6 sm:p-8 border border-slate-200/60 dark:border-slate-700/60 shadow-lg">
          <div className="grid grid-cols-1 md:grid-cols-2 md:gap-12">
            ...
            <div>
              ...
              <div className="space-y-4">
                <div className="flex justify-between items-center p-4 bg-slate-50/80 dark:bg-slate-700/50 rounded-xl">
                  <div>
            ...
            <div className="mt-10 md:mt-0 flex flex-col justify-center">
              <button
                ...
                disabled={isLoading}
                className="w-full bg-gradient-to-r from-indigo-500 via-violet-500 to-cyan-500 text-white font-semibold py-4 rounded-xl flex items-center justify-center space-x-2 hover:from-indigo-600 hover:via-violet-600 hover:to-cyan-600 transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed text-lg shadow-[0_4px_15px_rgba(99,102,241,0.3)] hover:shadow-[0_6px_20px_rgba(99,102,241,0.4)] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-400"
              >
                {isLoading ? (
                  <>
              ...
              <p className="text-xs text-slate-600 dark:text-slate-400 text-center mt-4">
                By confirming, you allow Infinity to charge you for this payment
