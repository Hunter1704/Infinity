...
const ShareModal = ({ isOpen, onClose, problem }) => {
  ...
  const problemUrl = typeof window !== 'undefined'
    ...
    : `https://www.infinity.dev/problems/${problem._id}`;

  const shareTextForSocial = `Check out the problem: "${problemTitle}" on Infinity!`;
  const shareMessageForCopy = `I'm working on the "${problemTitle}" problem on Infinity!\nCheck it out: <${problemUrl}>`;
        ...
        >
          <FocusTrap active={isOpen}>
            <motion.div
              ...
              className="relative w-full max-w-2xl p-8 rounded-2xl shadow-2xl bg-white/90 dark:bg-slate-800/90 backdrop-blur-xl border border-slate-200/50 dark:border-slate-700/50 scale-80"
            ...
            >
              <div className="flex justify-between items-center mb-6">
                ...
                <button
                  onClick={onClose}
                  className="p-1.5 rounded-full text-gray-500 hover:bg-gray-200 dark:text-slate-400 dark:hover:bg-slate-700 focus:ring-indigo-500"
              ...
              <div className="mb-6">
                ...
                <div className="flex space-x-2">
                  ...
                  <button
                    ...
                    className={`${commonButtonClass} px-4 text-sm font-medium bg-gradient-to-r from-indigo-500 to-violet-500 text-white hover:from-indigo-600 hover:to-violet-600 focus:ring-indigo-500`}
                  >
              ...
              <div className="mb-8">
                ...
                <div className="flex space-x-2">
                  ...
                  <button
                    ...
                    className={`${commonButtonClass} px-4 text-sm font-medium self-start bg-gradient-to-r from-indigo-500 to-violet-500 text-white hover:from-indigo-600 hover:to-violet-600 focus:ring-indigo-500`}
                  >
                ...
                <div className="grid grid-cols-3 sm:grid-cols-5 gap-4">
                  {socialPlatforms.map(platform => (
                    <a
                      ...
                      className={`${commonButtonClass} flex-col space-y-1 h-20 bg-gray-100 hover:bg-gray-200 text-gray-700 hover:text-indigo-600 dark:bg-slate-700 dark:hover:bg-slate-600 dark:text-slate-200 dark:hover:text-indigo-400 focus:ring-indigo-500`}
