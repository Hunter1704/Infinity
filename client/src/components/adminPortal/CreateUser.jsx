...
const CreateUser = () => {
  ...
  const inputBaseClasses =
    "w-full bg-[#F1F5F9] dark:bg-[#0F293B] border border-[#E2E8F0] dark:border-[#334155] rounded-xl p-3 focus:ring-2 focus:ring-[#F97316] focus:border-[#F97316]/50 outline-none transition duration-200 placeholder:text-[#64748B]/60 dark:placeholder:text-[#94A3B8]/60";
  const labelClasses =
    "block text-sm font-medium mb-1.5 text-[#64748B] dark:text-[#94A3B8]";
  const errorClasses = "text-red-500 text-sm mt-1";
  const sectionClasses = "bg-[#FFFFFF] dark:bg-[#1E293B] p-8 rounded-xl border border-[#E2E8F0] dark:border-[#334155] shadow-md";
      ...
      <div className={sectionClasses}>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
          ...
          <div className="flex justify-end items-center space-x-4 pt-4">
            ...
            <button
              type="submit"
              className="group flex items-center space-x-2 py-3 px-6 rounded-lg bg-gradient-to-r from-[#F97316] to-[#EA580C] hover:from-[#FB923C] hover:to-orange-600 text-white font-bold shadow-lg hover:shadow-xl transition-all transform hover:-translate-y-0.5"
            >
